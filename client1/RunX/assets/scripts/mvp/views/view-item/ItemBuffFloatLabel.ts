...
@ccclass
export default class ItemBuffFloatLabel extends cc.Component {
    @property(cc.Label)
    label: cc.Label = null;

    show (info: BuffFloatLabel, finCallback: Function) {
        this._play(info, finCallback);
    }

    private _play (info: BuffFloatLabel, finCallback: Function) {
