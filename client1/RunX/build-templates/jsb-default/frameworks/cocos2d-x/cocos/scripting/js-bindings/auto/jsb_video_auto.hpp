...
SE_DECLARE_FUNC(js_video_VideoPlayer_setSkipBtnSource);
...
SE_DECLARE_FUNC(js_video_VideoPlayer_setSkipBtnVisible);
SE_DECLARE_FUNC(js_video_VideoPlayer_pushFrameDataToTexture2D);
SE_DECLARE_FUNC(js_video_VideoPlayer_setSkipBtnPosition);
