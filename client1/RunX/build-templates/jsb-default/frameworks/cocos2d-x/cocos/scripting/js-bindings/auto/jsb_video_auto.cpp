...
static bool js_video_VideoPlayer_setSkipBtnSource(se::State& s)
{
    cocos2d::VideoPlayer* cobj = (cocos2d::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_video_VideoPlayer_setSkipBtnSource : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_video_VideoPlayer_setSkipBtnSource : Error processing arguments");
        cobj->setSkipBtnSource(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_video_VideoPlayer_setSkipBtnSource)
...
static bool js_video_VideoPlayer_setSkipBtnVisible(se::State& s)
{
    cocos2d::VideoPlayer* cobj = (cocos2d::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_video_VideoPlayer_setSkipBtnVisible : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_video_VideoPlayer_setSkipBtnVisible : Error processing arguments");
        cobj->setSkipBtnVisible(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_video_VideoPlayer_setSkipBtnVisible)
...
static bool js_video_VideoPlayer_setSkipBtnPosition(se::State& s)
{
    cocos2d::VideoPlayer* cobj = (cocos2d::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_video_VideoPlayer_setSkipBtnPosition : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 2) {
        ...
        SE_PRECONDITION2(ok, false, "js_video_VideoPlayer_setSkipBtnPosition : Error processing arguments");
        cobj->setSkipBtnPosition(arg0, arg1);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 2);
    return false;
}
SE_BIND_FUNC(js_video_VideoPlayer_setSkipBtnPosition)
...
bool js_register_video_VideoPlayer(se::Object* obj)
{
    ...
    cls->defineFunction("setSkipBtnSource", _SE(js_video_VideoPlayer_setSkipBtnSource));
    ...
    cls->defineFunction("setSkipBtnVisible", _SE(js_video_VideoPlayer_setSkipBtnVisible));
    cls->defineFunction("pushFrameDataToTexture2D", _SE(js_video_VideoPlayer_pushFrameDataToTexture2D));
    cls->defineFunction("setSkipBtnPosition", _SE(js_video_VideoPlayer_setSkipBtnPosition));
