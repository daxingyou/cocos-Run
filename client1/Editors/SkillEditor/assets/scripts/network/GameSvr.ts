import { comm, gamesvr } from "./lib/protocol"
...
export default class GameSvr {
    ...
    login (userid:string, gamesvrUrl:string, succ:LoginSuccCallback, fail:LoginFailCallback) {
        this.clear()
        ...
        this._socket.onopen = (ev:Event)=>{
            ...
            this.send(gamesvr.LoginReq.create({UserID:userid}))
        }
